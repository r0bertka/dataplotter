...
amplitude = data[:, 0] / 1000  # in V
t_rabi = data[:, 1] * 1e-9  # in s

f_rabi = 1 / t_rabi * 1e-3  # in kHz

params, covar = curve_fit(linear_fit, amplitude, f_rabi, p0=[1, 1])
...
plt.savefig('C:\\Users\\rober\\Documents\\t_rabi_vs_mw_amplitude.png')
